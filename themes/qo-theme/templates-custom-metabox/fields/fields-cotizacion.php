<div id="qo_cotizaciones">
	...
	<div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            <div class="col col-1_4">
    ...
    <div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra5_2" id="qo_cotizaciones_muestra5_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra5_2; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra5_3" id="qo_cotizaciones_muestra5_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra5_3; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra5_4" id="qo_cotizaciones_muestra5_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra5_4; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="col col-1-2_4"><input type="number" name="qo_cotizaciones_precio6" value="<?php echo $precio6; ?>"></div>
        <div class="col col-1_4"><textarea name="qo_cotizaciones_detalle2"><?php echo $detalle2; ?></textarea></div>
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra6_1" id="qo_cotizaciones_muestra6_1" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra6_1; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra6_2" id="qo_cotizaciones_muestra6_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra6_2; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra6_3" id="qo_cotizaciones_muestra6_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra6_3; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra6_4" id="qo_cotizaciones_muestra6_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra6_4; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra7_2" id="qo_cotizaciones_muestra7_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra7_2; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra7_3" id="qo_cotizaciones_muestra7_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra7_3; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra7_4" id="qo_cotizaciones_muestra7_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra7_4; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="col col-1-2_4"><input type="number" name="qo_cotizaciones_precio8" value="<?php echo $precio8; ?>"></div>
        <div class="col col-1_4"><textarea name="qo_cotizaciones_detalle2"><?php echo $detalle2; ?></textarea></div>
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra8_1" id="qo_cotizaciones_muestra8_1" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra8_1; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra8_2" id="qo_cotizaciones_muestra8_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra8_2; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra8_3" id="qo_cotizaciones_muestra8_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra8_3; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra8_4" id="qo_cotizaciones_muestra8_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra8_4; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra9_2" id="qo_cotizaciones_muestra9_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra9_2; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra9_3" id="qo_cotizaciones_muestra9_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra9_3; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra9_4" id="qo_cotizaciones_muestra9_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra9_4; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="col col-1-2_4"><input type="number" name="qo_cotizaciones_precio10" value="<?php echo $precio10; ?>"></div>
        <div class="col col-1_4"><textarea name="qo_cotizaciones_detalle2"><?php echo $detalle2; ?></textarea></div>
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra10_1" id="qo_cotizaciones_muestra10_1" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra10_1; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra10_2" id="qo_cotizaciones_muestra10_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra10_2; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra10_3" id="qo_cotizaciones_muestra10_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra10_3; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra10_4" id="qo_cotizaciones_muestra10_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra10_4; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra11_2" id="qo_cotizaciones_muestra11_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra11_2; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra11_3" id="qo_cotizaciones_muestra11_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra11_3; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra11_4" id="qo_cotizaciones_muestra11_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra11_4; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="col col-1-2_4"><input type="number" name="qo_cotizaciones_precio12" value="<?php echo $precio12; ?>"></div>
        <div class="col col-1_4"><textarea name="qo_cotizaciones_detalle2"><?php echo $detalle2; ?></textarea></div>
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra12_1" id="qo_cotizaciones_muestra12_1" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra12_1; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra12_2" id="qo_cotizaciones_muestra12_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra12_2; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra12_3" id="qo_cotizaciones_muestra12_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra12_3; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra12_4" id="qo_cotizaciones_muestra12_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra12_4; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra13_2" id="qo_cotizaciones_muestra13_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra13_2; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra13_3" id="qo_cotizaciones_muestra13_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra13_3; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra13_4" id="qo_cotizaciones_muestra13_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra13_4; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="col col-1-2_4"><input type="number" name="qo_cotizaciones_precio14" value="<?php echo $precio14; ?>"></div>
        <div class="col col-1_4"><textarea name="qo_cotizaciones_detalle2"><?php echo $detalle2; ?></textarea></div>
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra14_1" id="qo_cotizaciones_muestra14_1" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra14_1; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra14_2" id="qo_cotizaciones_muestra14_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra14_2; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra14_3" id="qo_cotizaciones_muestra14_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra14_3; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra14_4" id="qo_cotizaciones_muestra14_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra14_4; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="hide-on-templateHorizontal">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra15_2" id="qo_cotizaciones_muestra15_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra15_2; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra15_3" id="qo_cotizaciones_muestra15_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra15_3; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
            ...
            <div class="col col-1_4">
                <div class="input-image">
                    <input type="text" name="qo_cotizaciones_muestra15_4" id="qo_cotizaciones_muestra15_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra15_4; ?>">
                    <input type="button" class="button image-upload" value="Seleccionar">
                </div>
                <div class="image-preview">
    ...
    <div class="row margin-bottom">
        ...
        <div class="col col-1-2_4"><input type="number" name="qo_cotizaciones_precio16" value="<?php echo $precio16; ?>"></div>
        <div class="col col-1_4"><textarea name="qo_cotizaciones_detalle2"><?php echo $detalle2; ?></textarea></div>
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra16_1" id="qo_cotizaciones_muestra16_1" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra16_1; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra16_2" id="qo_cotizaciones_muestra16_2" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra16_2; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra16_3" id="qo_cotizaciones_muestra16_3" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra16_3; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
        ...
        <div class="col col-1_4">
            <div class="input-image">
                <input type="text" name="qo_cotizaciones_muestra16_4" id="qo_cotizaciones_muestra16_4" class="meta-image regular-text" placeholder="Muestra" value="<?php echo $muestra16_4; ?>">
                <input type="button" class="button image-upload" value="Seleccionar">
            </div>
            <div class="image-preview">
