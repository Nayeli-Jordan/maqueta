			...
			<?php
		        ...
		        if ( $loop->have_posts() ) {
		            while ( $loop->have_posts() ) : $loop->the_post(); 
						...
						/* Actiavar alerta desde 3 días antes de la fecha límite*/
						...
						if (($todayDate >= $activeAlertDate && $estatus != 'Cerrado' && $fechaEntregaAlert != 'Desactivar alerta')){ 
							...
							if ($responsableMail != '') {
								$to 	 = $responsableMail . "pruebas@altoempleo.com.mx"; /* to do - cambiar a email jeaninne para que le llegue copia de todos */
