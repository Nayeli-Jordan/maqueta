...
<div id="modal-tiempo-creativo_mkt" class="modal">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<form id="update_brief_tiempo_mkt" name="update_brief_tiempo_mkt" action="" method="post" class="validation row"  enctype="multipart/form-data" data-parsley-qo_briefTiempo_mkt data-parsley-validate="">
		        <label>Tiempo*</label>
				...
				<input type="submit" id="qo_briefTiempo_mkt_submit" name="qo_briefTiempo_mkt_submit" class="width-100p" value="Actualizar"/>
				<input type="hidden" name="edit_tiempo_mktBrief" value="post" />
				<?php wp_nonce_field( 'update_brief_tiempo_mkt' ); ?>
			</form>
			<? if( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['edit_tiempo_mktBrief'] )) : 
				...
				$message 			.= '<p><span style="text-transform: uppercase; font-weight: 600; color: #7b2183;">Tiempo Creativo Diseño Visual: </span>' . $nuevoTiempoCreativo_mkt . '</span></p>';
				...
				if ($tiempoCreativo_mkt != $nuevoTiempoCreativo_mkt) { 
