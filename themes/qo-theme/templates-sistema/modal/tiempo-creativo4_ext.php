...
<div id="modal-tiempo-creativo4_ext" class="modal">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<form id="update_brief_tiempo4_ext" name="update_brief_tiempo4_ext" action="" method="post" class="validation row"  enctype="multipart/form-data" data-parsley-qo_briefTiempo4_ext data-parsley-validate="">
		        <label>Tiempo*</label>
				...
				<input type="submit" id="qo_briefTiempo4_ext_submit" name="qo_briefTiempo4_ext_submit" class="width-100p" value="Actualizar"/>
				<input type="hidden" name="edit_tiempo4_extBrief" value="post" />
				<?php wp_nonce_field( 'update_brief_tiempo4_ext' ); ?>
			</form>
			<? if( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['edit_tiempo4_extBrief'] )) : 
				...
				$message 			.= '<p><span style="text-transform: uppercase; font-weight: 600; color: #7b2183;">Tiempo Creativo  Actualización #4: </span>' . $nuevotiempoCreativo4_ext . '</span></p>';
				...
				if ($tiempoCreativo4_ext != $nuevotiempoCreativo4_ext) { 
