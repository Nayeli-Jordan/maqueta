...
<div id="modal-tiempo-creativo2_ext" class="modal">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<form id="update_brief_tiempo2_ext" name="update_brief_tiempo2_ext" action="" method="post" class="validation row"  enctype="multipart/form-data" data-parsley-qo_briefTiempo2_ext data-parsley-validate="">
		        <label>Tiempo*</label>
				...
				<input type="submit" id="qo_briefTiempo2_ext_submit" name="qo_briefTiempo2_ext_submit" class="width-100p" value="Actualizar"/>
				<input type="hidden" name="edit_tiempo2_extBrief" value="post" />
				<?php wp_nonce_field( 'update_brief_tiempo2_ext' ); ?>
			</form>
			<? if( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['edit_tiempo2_extBrief'] )) : 
				...
				$message 			.= '<p><span style="text-transform: uppercase; font-weight: 600; color: #7b2183;">Tiempo Creativo  Actualización #2: </span>' . $nuevotiempoCreativo2_ext . '</span></p>';
				...
				if ($tiempoCreativo2_ext != $nuevotiempoCreativo2_ext) { 
